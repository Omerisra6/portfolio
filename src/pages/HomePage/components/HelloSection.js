...
const StyledHelloSection = styled.div`
    ...
    .hello-text-container, .pinned-projects-container{
        position: relative;
        display: flex;
                ...
                <div className='pinned-projects-container'>
                    ...
                    <div className='projects-links-container'>
                        ...
                        { Object.entries( pinnedProjects ).map( ( [ url, title ] ) => {
                            return <PinnedProject url={ url } title={ title }/>
                        })}   
