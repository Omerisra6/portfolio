          ...
          <div className='frontend-wrapper about-wrapper'>
            <div className='about-paragraph frontend'>
              ...
              <p className='paragraph-content'>
                As a Full-Stack Developer with experience in HTML, CSS, JavaScript, React, and TypeScript,  I bring a comprehensive skill set to the table. My goal is to build application that are beautiful, accessible, easy to use, and maintainable.
                I am dedicated to creating a smooth and intuitive user experience, ensuring that the application is user-friendly and responsive across different devices and screen sizes.
              </p>
        ...
        <div className='about-row backend-row'>
          ...
          <div className='about-wrapper backend-wrapper'>
              ...
              <div className='about-paragraph backend'>
                ...
                <p className='paragraph-content'>
                  As a Full-Stack Developer, I have a strong focus on backend development and possess extensive skills and experience in PHP/Laravel, MySQL, Node.js/Express, MongoDB, and NoSQL databases. 
                  I understand the importance of writing clean and maintainable code, which allows for easier collaboration and future enhancements.
                  With my strong backend skills and experience, I can design and develop efficient APIs that deliver data securely and efficiently, ensuring optimal performance and a smooth user experience. 
                </p>
